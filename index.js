...
const allowedOrigins = ['http://localhost:5173', 'https://localhost:5173', 'https://localhost:5174','https://app.seedpad.io', 'https://seedpad-frontend.vercel.app']; // Add your domain here if you start using one
